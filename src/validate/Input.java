...
public class Input {
            ...
            try {
                ...
                if (type.equals("add")) {
                    if (flMap.findFlByNum(flNum) != null) {
                        throw new Exception("Your Flight is exist.");
                    } else {
                        return flNum;
                    }
                }
                if (type.equals("find")) {
                    if (flMap.findFlByNum(flNum) == null) {
                        throw new Exception("Your Flight is not exist.");
                    } else {
                        return flNum;
                    }
                }
    ...
    public int inputOrderSeat() {
        int orderSeat;
        do {
            try {
                System.out.println("Input your number Seat you want to choice:");
                orderSeat = sc.nextInt();
                if (Validation.checkNullString(String.valueOf(orderSeat))) {
                    throw new Exception("DO NOT EMPTY.");
                }
                return orderSeat;
            } catch (Exception e) {
